...
"""
TURN_EXP           = 1.5     # 曲线形状：越大弯内越慢；1.6~2.5 之间调
...
"""
BRAKE_PER_STEP     = 1.5 * ACCEL_PER_STEP   # 超限时每帧自动减速量（平滑降速的力度）
...
"""
LIMIT_SMOOTH_ALPHA = 0.3     # 限速的低通平滑（0~1，越大响应越快）
